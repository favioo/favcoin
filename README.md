...
3. Buy one or two Ubuntu-16.04-based dedicated servers (at least 2Gb of RAM) for seed nodes.
4. Install dependencies: **sudo apt-get install build-essential git cmake libboost1.55-all-dev**
